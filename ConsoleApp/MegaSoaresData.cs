...
{
    internal class MegaSoaresDocumentProvider : IDocumentProvider
    {
        private bool disposed = false;
        private MegaSoaresDocumentReader reader;
    ...
    internal class MegaSoaresDocumentReader : IDocumentReader
    {
        private const string ConnectionString = "Data Source=.\\SQLEXPRESS;Initial Catalog=megasoareshlog-2018-5-14-10-31;Integrated Security=True;";
        ...
        private void SetCurrentDocumentFromProduct(Product p)
        {
    ...
    internal class MegaSoaresSearchDomain : SearchDomain
    {
